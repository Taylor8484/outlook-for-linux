...
const config: Config = {
  ...
  tagline: 'Unofficial Microsoft Outlook desktop client for Linux - Documentation',
  ...
  url: 'https://taylor8484.github.io',
  ...
  organizationName: 'Taylor8484', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/Taylor8484/outlook-for-linux/tree/develop-outlook/docs-site/',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Taylor8484/outlook-for-linux',
          label: 'GitHub',
          position: 'right',
        ...
        {
          href: 'https://github.com/Taylor8484/outlook-for-linux/releases',
          label: 'Releases',
          position: 'right',
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'GitHub Issues',
              href: 'https://github.com/Taylor8484/outlook-for-linux/issues',
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              label: 'License',
              href: 'https://github.com/Taylor8484/outlook-for-linux/blob/develop-outlook/LICENSE.md',
            },
          ],
        },
      ],
