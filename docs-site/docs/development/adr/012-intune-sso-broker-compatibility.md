...
The Intune SSO feature in teams-for-linux (inherited by Outlook for Linux) stopped working with Microsoft Identity Broker versions 2.0.2 and newer. Users reported the error:
...
- Issue: upstream teams-for-linux #2047
